...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('report.data-report') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2">
                    ...
                    @elseif(Auth::user()->role == 'HEAD_STAFF')
                        <li class="nav-item">
                            <a href="{{ route('staff.index') }}" class="nav-link {{ Route::is('staff.index') ? 'active' : '' }}">
                                <i class="fa-solid fa-file-alt"></i> Data
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('staff.create') }}"
                                class="nav-link {{ Route::is('staff.create') ? 'active' : '' }}"><i
